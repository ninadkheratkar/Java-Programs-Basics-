...
public class BarkingDog {
	...
	public static boolean shouldWakeUp(boolean barking, int houroftheday) {
		...
		else if (barking == false && houroftheday<8 && houroftheday >0) {
			return false;
			
		}
		else if (barking == false && houroftheday>22 && houroftheday <23) {
			return false;
		}
		
		else if (barking == true && houroftheday <0) {
			return false;
		}
		
		else if (barking == true && houroftheday>23) {
			return false;
		}
		return false;
